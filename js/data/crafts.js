export const crafts = {
  ...
  processRabbit: { name: "兔子", skill: "hunting", costs: { rabbit: 1 }, yields: { rawMeat: 2, hide: 1, bone: 1 }, stamina: 1 },
  processChicken: { name: "雞", skill: "hunting", costs: { chicken: 1 }, yields: { rawChicken: 1, feather: 2, bone: 1 }, stamina: 1 },
  processBoar: { name: "野豬", skill: "hunting", costs: { boar: 1 }, yields: { rawMeat: 5, offal: 2, hide: 2, bone: 2, boarTusk: 1 }, stamina: 2 },
  processDeer: { name: "鹿", skill: "hunting", costs: { deer: 1 }, yields: { rawMeat: 4, offal: 1, hide: 2, bone: 2, deerAntler: 1 }, stamina: 2 },
  processWolf: { name: "野狼", skill: "hunting", costs: { wolf: 1 }, yields: { rawMeat: 3, offal: 1, hide: 1, bone: 2 }, stamina: 2 },
  processBrownBear: { name: "棕熊", skill: "hunting", costs: { brownBear: 1 }, yields: { rawMeat: 8, offal: 3, hide: 3, bone: 3, bearPaw: 1, bearFang: 1 }, stamina: 3 },
  processBlackBear: { name: "黑熊", skill: "hunting", costs: { blackBear: 1 }, yields: { rawMeat: 10, offal: 4, hide: 4, bone: 4, bearPaw: 1, bearFang: 1 }, stamina: 3 },
  processDairyCow: { name: "乳牛", skill: "hunting", costs: { dairyCow: 1 }, yields: { rawMeat: 6, hide: 2, bone: 2, milk: 2 }, stamina: 2 },
  processBull: { name: "公牛", skill: "hunting", costs: { bull: 1 }, yields: { rawMeat: 6, hide: 2, bone: 2, cowHorn: 1 }, stamina: 2 },
  processShellfish: { name: "貝類", skill: "gathering", costs: { shellfish: 1 }, yields: { shell: 1, clamMeat: 1 }, stamina: 1 }
};
