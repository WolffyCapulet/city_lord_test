...
function getSkillDetailText({
  ...
  const detailMap = {
    ...
    lumber: [
      "效果：伐木熟練度記錄。",
      `伐木廠加成：+${(buildings.lumberMill || 0) * 10}% 技能經驗`
    ],
    mining: [
      "效果：採礦熟練度記錄。",
      "Lv.10 解鎖：銀礦 / 磁石 / 水晶",
    ...
    fishing: [
      "效果：釣魚熟練度記錄。",
      `釣魚小屋加成：+${(buildings.fishingShack || 0) * 10}% 技能經驗`
    ],
    hunting: [
      "效果：狩獵熟練度記錄。"
    ],
    ...
    digging: [
      "效果：挖掘熟練度記錄。",
      `採石場加成：+${(buildings.quarry || 0) * 10}% 技能經驗`
    ],
    farming: [
      "效果：耕種熟練度記錄。"
    ],
